...
def student(student_id):
    students = Student.query.get_or_404(student_id)
    return(render_template('student.html', student=students))
...
def addbooks():
    # if request.method == 'POST':
        ...
        # student = User(firstname=firstname, lastname=lastname, email=email, age=age, bio=bio)
